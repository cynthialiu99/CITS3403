...
class UserModelCase(unittest.TestCase):
    def setUp(self):
        ...
        db.create_all()
        user1 = User(id = 0, username='25123456', email='25123456@student.uwa.edu.au', admin=False)
        user2 = User(id = 1, username='08679768', email='08679768@uwa.edu.au', admin=False)
